...
import cn.xiao.springbootinit.constant.FileConstant;
import cn.xiao.springbootinit.enums.FileUploadBizEnum;
import cn.xiao.springbootinit.exception.BusinessException;
import cn.xiao.springbootinit.manager.CosManager;
import cn.xiao.springbootinit.model.dto.file.UploadFileRequest;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        if (ObjectUtil.isEmpty(fileUploadBizEnum) || ObjectUtil.isEmpty(fileUploadBizEnum.getValue())) {
