...
import cn.xiao.springbootinit.common.DeleteRequest;
...
import cn.xiao.springbootinit.model.dto.post.PostAddRequest;
import cn.xiao.springbootinit.model.dto.post.PostEditRequest;
import cn.xiao.springbootinit.model.dto.post.PostQueryRequest;
import cn.xiao.springbootinit.model.dto.post.PostUpdateRequest;
...
public class PostController {
    ...
    public BaseResponse<Long> addPost(@RequestBody PostAddRequest postAddRequest, HttpServletRequest request) {
        if (ObjectUtil.isEmpty(postAddRequest)) {
    ...
    public BaseResponse<Boolean> deletePost(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(ObjectUtil.isEmpty(oldPost), ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可删除
    ...
    public BaseResponse<Boolean> updatePost(@RequestBody PostUpdateRequest postUpdateRequest) {
        if (ObjectUtil.isEmpty(postUpdateRequest) || postUpdateRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Post post = new Post();
    ...
    public BaseResponse<Boolean> editPost(@RequestBody PostEditRequest postEditRequest, HttpServletRequest request) {
        if (ObjectUtil.isEmpty(postEditRequest) || postEditRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Post post = new Post();
