...
import cn.xiao.springbootinit.config.WxOpenConfig;
...
import cn.xiao.springbootinit.model.dto.user.UserAddRequest;
import cn.xiao.springbootinit.model.dto.user.UserLoginRequest;
import cn.xiao.springbootinit.model.dto.user.UserQueryRequest;
import cn.xiao.springbootinit.model.dto.user.UserRegisterRequest;
import cn.xiao.springbootinit.model.dto.user.UserUpdateMyRequest;
import cn.xiao.springbootinit.model.dto.user.UserUpdateRequest;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateUser(@RequestBody UserUpdateRequest userUpdateRequest,
        ...
        if (ObjectUtil.isEmpty(userUpdateRequest) || ObjectUtil.isEmpty(userUpdateRequest.getId())) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        User user = new User();
