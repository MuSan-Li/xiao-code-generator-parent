...
import cn.xiao.springbootinit.wxmp.WxMpConstant;
...
public class WxMpController {
    ...
    public void receiveMessage(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("aes".equals(encryptType)) {
            ...
            if (ObjectUtil.isEmpty(outMessage)) {
    ...
    public String setMenu() throws WxErrorException {
        ...
        wxMenuButton1SubButton1.setUrl("https://exotisch.cn");
        ...
        wxMenuButton3SubButton1.setUrl("https://exotisch.cn");
