...
import {Button, Card, Col, Collapse, Divider, Form, Image, Input, message, Row, Space,} from 'antd';
      ...
      <Card>
        <Row justify="space-between" gutter={[32, 32]}>
          <Col flex="auto">
            ...
            <Typography.Paragraph>{data.description}</Typography.Paragraph> <Divider/>
            <Form form={form}>
